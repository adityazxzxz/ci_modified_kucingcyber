...
<head>
    ...
    <title>themelock.com - SlickLab - Responsive Admin Dashboard Template</title>
    ...
    <section>
        ...
        <div class="sidebar-left">
            ...
            <div class="logo dark-logo-bg visible-xs-* visible-sm-*">
                <a href="index.html">
                    <img src="<?php echo base_url()?>/assets/img/logo-icon.png" alt="">
                    ...
                    <ul class="nav navbar-nav">
                                    ...
                                    <div class="yamm-content">
                                        <div class="row">
                                            ...
                                            <ul class="col-sm-3 list-unstyled">
                                                ...
                                                <li>
                                                    <a href="javascript:;">
                                                        <img class="icon-img" src="<?php echo base_url()?>/assets/img/mega-menu/mega_icon1.png" alt="" />
                                                ...
                                                <li>
                                                    <a href="javascript:;">
                                                        <img class="icon-img" src="<?php echo base_url()?>/assets/img/mega-menu/mega_icon2.png" alt="" />
                                                                <span class="icon-desk">
                                                                                        <span class="d-title">Amaging Dashboard</span>
                                                                <span class="d-desk">Build with BS3</span>
                                                                </span>
                                                ...
                                                <li>
                                                    <a href="javascript:;">
                                                        <img class="icon-img" src="<?php echo base_url()?>/assets/img/mega-menu/mega_icon3.png" alt="" />
                                                                <span class="icon-desk">
                                                                                        <span class="d-title">3500+ Satisfied Client</span>
                                                                <span class="d-desk">Max 5 star rating</span>
                                                                </span>
                                                ...
                                                <li>
                                                    <a href="javascript:;">
                                                        <img class="icon-img" src="<?php echo base_url()?>/assets/img/mega-menu/mega_icon4.png" alt="" />
                                                                <span class="icon-desk">
                                                                                        <span class="d-title">Easy to Cutomize</span>
                                                                <span class="d-desk">Very easy to use</span>
                                                                </span>
                        ...
                        <li class="dropdown"><a href="javascript:;" data-toggle="dropdown" class="dropdown-toggle"> English  <b
                            ...
                            <ul role="menu" class="dropdown-menu language-switch">
                                <li>
                                    <a tabindex="-1" href="javascript:;"><span> German </span><img src="<?php echo base_url()?>/assets/img/flags/germany_flag.jpg" alt=""/></a>
                                </li>
                                <li>
                                    <a tabindex="-1" href="javascript:;"><span> Italian </span> <img src="<?php echo base_url()?>/assets/img/flags/italy_flag.jpg" alt=""/></a>
                                </li>
                                <li>
                                    <a tabindex="-1" href="javascript:;"><span> French </span> <img src="<?php echo base_url()?>/assets/img/flags/french_flag.jpg" alt=""/></a>
                                </li>
                                <li>
                                    <a tabindex="-1" href="javascript:;"><span> Spanish </span> <img src="<?php echo base_url()?>/assets/img/flags/spain_flag.jpg" alt=""/></a>
                                </li>
                                <li>
                                    <a tabindex="-1" href="javascript:;"><span> Russian </span> <img src="<?php echo base_url()?>/assets/img/flags/russia_flag.jpg" alt=""/></a>
                                </li>
                            </ul>
                        </li>
                    ...
                    <ul class="notification-menu">
                        ...
                        <li>
                            <a href="javascript:;" class="btn btn-default dropdown-toggle" data-toggle="dropdown">
                                <img src="<?php echo base_url()?>/assets/img/avatar-mini.jpg" alt=""><?php echo $this->session->userdata('name')?>
                    ...
                    <div class="online-chat-container">
                        ...
                        <ul class="team-list chat-list-side">
                            <li>
                                ...
                                <img class="circle" src="<?php echo base_url()?>/assets/img/img2.jpg" alt="">
                            ...
                            <li>
                                <a href="#">
                                        <span class="thumb-small">
                                <img class="circle" src="<?php echo base_url()?>/assets/img/img3.jpg" alt="">
                                <i class="online dot"></i>
                            </span>
                                    <div class="inline">
                                            <span class="name">
                            ...
                            <li>
                                <a href="#">
                                        <span class="thumb-small">
                                <img class="circle" src="<?php echo base_url()?>/assets/img/img1.jpg" alt="">
                                <i class="away dot"></i>
                            </span>
                                    <div class="inline">
                                            <span class="name">
